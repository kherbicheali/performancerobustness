...
% captures d’écrans 
 ...
 \section{Détermination de la contrainte sur le gabarit de $S(p)$}  
  ...
  \subsection{Création du gabarit sur l'erreur de position}
   ...
   \begin{center}
    %\includegraphics[scale=0.5]{Logo_UT3.jpg}
    \captionof{figure}{\textit{Diagramme illustrant le gabarit sur l'erreur de position}}
    \label{fig4}
  \end{center}
  ...
  \begin{center}
    %\includegraphics[scale=0.5]{Logo_UT3.jpg}
    \captionof{figure}{\textit{Diagramme illustrant le gabarit sur l'erreur de vitesse}}
    \label{fig5}
  \end{center}
